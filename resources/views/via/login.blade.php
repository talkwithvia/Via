...
<head>
    ...
    <meta name="description" content="Sign in to access your VIA account.">
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .field-wrap { margin-bottom: 1rem; text-align: left; }
...
<body>
    ...
    <main class="main-content">
        <div class="auth-card">
            ...
            <!-- Google -->
            <a href="{{ route('socialite.redirect', 'google') }}" class="btn-auth" id="googleBtn">
                <!-- Google G icon -->
            ...
            <!-- Apple -->
            <a href="{{ route('socialite.redirect', 'apple') }}" class="btn-auth" id="appleBtn">
            ...
            <a href="#" class="btn-auth" id="emailToggleBtn" onclick="toggleEmailForm(event)">
            ...
            <!-- Email login form (hidden by default, shown on toggle) -->
